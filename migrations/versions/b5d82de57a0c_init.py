...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "status",
            sa.Enum("CREATED", "ASSIGNED", "IN_PROGRESS", "DELIVERED", "CANCELLED", name="order_status"),
            nullable=False,
        ),
        sa.Column("source", sa.String(length=100), nullable=True),
        sa.Column(
            "delivery_service_level", sa.Enum("STANDARD", "EXPRESS", name="delivery_service_level"), nullable=False
        ),
        sa.Column("tracking_id", sa.UUID(), nullable=False),
        sa.Column(
            "payment_method",
            sa.Enum("PREPAID", "CASH_ON_DELIVERY", "CARD_ON_DELIVERY", name="payment_method"),
            nullable=False,
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "content_type",
            sa.Enum("LETTER", "FOOD", "GROCERY", "ELECTRONICS", "CLOTHING", "OTHER", name="content_type"),
            nullable=False,
        ),
        sa.Column("description", sa.Text(), nullable=True),
